...
covers core Dart concepts through two complete programs.

### Task 1: Number Analysis App
A Dart program that analyzes a list of integers using four manually
implemented functions — findMax, findMin, calculateSum, and
...
four arithmetic operations, exception handling for division by zero,
